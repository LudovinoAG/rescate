...
<head>
    ...
    <title>Rescate - Mantenimiento</title>
</head>
<body>
<div class='container'>
    ...
    <section class='contenido_manten'>
        <div class='row'>
            <div class='col-lg-12'>
                    ...
                    <!-- <div>
                        <div class='form-group'>
                            <label for="file"> Archivo a subir
                                <input type="file" name='file' id='file'>
                            </label>
                            <button class='btn btn-primary btn-sm'>Cargar archivo</button>
